	...
	void add_node_template_subtract(BlueprintNodeLibraryPtr library)
	{
		library->add_template("Subtract",
			...
			[](BlueprintArgument* inputs, BlueprintArgument* outputs) {
				...
				case  0x01: *(vec2*)	outputs[0].data	=			*(vec2*)	inputs[0].data					-	vec2(	*(float*)inputs[1].data, 0);		break;
				case  0x02: *(vec3*)	outputs[0].data	=			*(vec3*)	inputs[0].data					-	vec3(	*(float*)inputs[1].data, 0, 0);		break;
				case  0x03: *(vec4*)	outputs[0].data	=			*(vec4*)	inputs[0].data					-	vec4(	*(float*)inputs[1].data, 0, 0, 0);	break;
				case  0x04: *(float*)	outputs[0].data	=			*(int*)		inputs[0].data					-			*(float*)inputs[1].data;			break;
				case  0x05: *(vec2*)	outputs[0].data	= vec2(		*(ivec2*)	inputs[0].data)					-	vec2(	*(float*)inputs[1].data, 0);		break;
				case  0x06: *(vec3*)	outputs[0].data	= vec3(		*(ivec3*)	inputs[0].data)					-	vec3(	*(float*)inputs[1].data, 0, 0);		break;
				case  0x07: *(vec4*)	outputs[0].data	= vec4(		*(ivec4*)	inputs[0].data)					-	vec4(	*(float*)inputs[1].data, 0, 0, 0);	break;
				case  0x08: *(float*)	outputs[0].data	=			*(uint*)	inputs[0].data					-			*(float*)inputs[1].data;			break;
				case  0x09: *(vec2*)	outputs[0].data	= vec2(		*(uvec2*)	inputs[0].data)					-	vec2(	*(float*)inputs[1].data, 0);		break;
				case  0x0a: *(vec3*)	outputs[0].data	= vec3(		*(uvec3*)	inputs[0].data)					-	vec3(	*(float*)inputs[1].data, 0, 0);		break;
				case  0x0b: *(vec4*)	outputs[0].data	= vec4(		*(uvec4*)	inputs[0].data)					-	vec4(	*(float*)inputs[1].data, 0, 0, 0);	break;
				...
				case  0x12: *(vec3*)	outputs[0].data	=			*(vec3*)	inputs[0].data					-	vec3(	*(vec2*)inputs[1].data, 0);			break;
				case  0x13: *(vec4*)	outputs[0].data	=			*(vec4*)	inputs[0].data					-	vec4(	*(vec2*)inputs[1].data, 0, 0);		break;
				...
				case  0x16: *(vec3*)	outputs[0].data	= vec3(		*(ivec3*)	inputs[0].data)					-	vec3(	*(vec2*)inputs[1].data, 0);			break;
				case  0x17: *(vec4*)	outputs[0].data	= vec4(		*(ivec4*)	inputs[0].data)					-	vec4(	*(vec2*)inputs[1].data, 0, 0);		break;
				...
				case  0x1a: *(vec3*)	outputs[0].data	= vec3(		*(uvec3*)	inputs[0].data)					-	vec3(	*(vec2*)inputs[1].data, 0);			break;
				case  0x1b: *(vec4*)	outputs[0].data	= vec4(		*(uvec4*)	inputs[0].data)					-	vec4(	*(vec2*)inputs[1].data, 0, 0);		break;
				...
				case  0x23: *(vec4*)	outputs[0].data	=			*(vec4*)	inputs[0].data					-	vec4(	*(vec3*)inputs[1].data, 0);			break;
				...
				case  0x27: *(vec4*)	outputs[0].data	= vec4(		*(ivec4*)	inputs[0].data)					-	vec4(	*(vec3*)inputs[1].data, 0);			break;
				...
				case  0x2b: *(vec4*)	outputs[0].data	= vec4(		*(uvec4*)	inputs[0].data)					-	vec4(	*(vec3*)inputs[1].data, 0);			break;
				...
				case  0x41: *(vec2*)	outputs[0].data	=			*(vec2*)	inputs[0].data					-	vec2(	*(int*)inputs[1].data, 0);			break;
				case  0x42: *(vec3*)	outputs[0].data	=			*(vec3*)	inputs[0].data					-	vec3(	*(int*)inputs[1].data, 0, 0);		break;
				case  0x43: *(vec4*)	outputs[0].data	=			*(vec4*)	inputs[0].data					-	vec4(	*(int*)inputs[1].data, 0, 0, 0);	break;
				case  0x44: *(int*)		outputs[0].data	=			*(int*)		inputs[0].data					-			*(int*)inputs[1].data;				break;
				case  0x45: *(ivec2*)	outputs[0].data	=			*(ivec2*)	inputs[0].data					-	ivec2(	*(int*)inputs[1].data, 0);			break;
				case  0x46: *(ivec3*)	outputs[0].data	=			*(ivec3*)	inputs[0].data					-	ivec3(	*(int*)inputs[1].data, 0, 0);		break;
				case  0x47: *(ivec4*)	outputs[0].data	=			*(ivec4*)	inputs[0].data					-	ivec4(	*(int*)inputs[1].data, 0, 0, 0);	break;
				case  0x48: *(int*)		outputs[0].data	=			*(uint*)	inputs[0].data					-			*(int*)inputs[1].data;				break;
				case  0x49: *(ivec2*)	outputs[0].data	= ivec2(	*(uvec2*)	inputs[0].data)					-	ivec2(	*(int*)inputs[1].data, 0);			break;
				case  0x4a: *(ivec3*)	outputs[0].data	= ivec3(	*(uvec3*)	inputs[0].data)					-	ivec3(	*(int*)inputs[1].data, 0, 0);		break;
				case  0x4b: *(ivec4*)	outputs[0].data	= ivec4(	*(uvec4*)	inputs[0].data)					-	ivec4(	*(int*)inputs[1].data, 0, 0, 0);	break;
				...
				case  0x52: *(vec3*)	outputs[0].data	=			*(vec3*)	inputs[0].data					-	vec3(	*(ivec2*)inputs[1].data, 0);		break;
				case  0x53: *(vec4*)	outputs[0].data	=			*(vec4*)	inputs[0].data					-	vec4(	*(ivec2*)inputs[1].data, 0, 0);		break;
				...
				case  0x56: *(ivec3*)	outputs[0].data	= ivec3(	*(ivec3*)	inputs[0].data)					-	ivec3(	*(ivec2*)inputs[1].data, 0);		break;
				case  0x57: *(ivec4*)	outputs[0].data	= ivec4(	*(ivec4*)	inputs[0].data)					-	ivec4(	*(ivec2*)inputs[1].data, 0, 0);		break;
				...
				case  0x5a: *(ivec3*)	outputs[0].data	= ivec3(	*(uvec3*)	inputs[0].data)					-	ivec3(	*(ivec2*)inputs[1].data, 0);		break;
				case  0x5b: *(ivec4*)	outputs[0].data	= ivec4(	*(uvec4*)	inputs[0].data)					-	ivec4(	*(ivec2*)inputs[1].data, 0, 0);		break;
				...
				case  0x63: *(vec4*)	outputs[0].data	=			*(vec4*)	inputs[0].data					-	vec4(	*(ivec3*)inputs[1].data, 0);		break;
				...
				case  0x67: *(ivec4*)	outputs[0].data	= ivec4(	*(ivec4*)	inputs[0].data)					-	ivec4(	*(ivec3*)inputs[1].data, 0);		break;
				...
				case  0x6b: *(ivec4*)	outputs[0].data	= ivec4(	*(uvec4*)	inputs[0].data)					-	ivec4(	*(ivec3*)inputs[1].data, 0);		break;
				...
				case  0x81: *(vec2*)	outputs[0].data	=			*(vec2*)	inputs[0].data					-	vec2(	*(uint*)inputs[1].data, 0);			break;
				case  0x82: *(vec3*)	outputs[0].data	=			*(vec3*)	inputs[0].data					-	vec3(	*(uint*)inputs[1].data, 0, 0);		break;
				case  0x83: *(vec4*)	outputs[0].data	=			*(vec4*)	inputs[0].data					-	vec4(	*(uint*)inputs[1].data, 0, 0, 0);	break;
				case  0x84: *(int*)		outputs[0].data	=			*(int*)		inputs[0].data					-			*(uint*)inputs[1].data;				break;
				case  0x85: *(ivec2*)	outputs[0].data	=			*(ivec2*)	inputs[0].data					-	ivec2(	*(uint*)inputs[1].data, 0);			break;
				case  0x86: *(ivec3*)	outputs[0].data	=			*(ivec3*)	inputs[0].data					-	ivec3(	*(uint*)inputs[1].data, 0, 0);		break;
				case  0x87: *(ivec4*)	outputs[0].data	=			*(ivec4*)	inputs[0].data					-	ivec4(	*(uint*)inputs[1].data, 0, 0, 0);	break;
				case  0x88: *(uint*)	outputs[0].data	=			*(uint*)	inputs[0].data					-			*(uint*)inputs[1].data;				break;
				case  0x89: *(uvec2*)	outputs[0].data	=			*(uvec2*)	inputs[0].data					-	uvec2(	*(uint*)inputs[1].data, 0);			break;
				case  0x8a: *(uvec3*)	outputs[0].data	=			*(uvec3*)	inputs[0].data					-	uvec3(	*(uint*)inputs[1].data, 0, 0);		break;
				case  0x8b: *(uvec4*)	outputs[0].data	=			*(uvec4*)	inputs[0].data					-	uvec4(	*(uint*)inputs[1].data, 0, 0, 0);	break;
				...
				case  0x92: *(vec3*)	outputs[0].data	=			*(vec3*)	inputs[0].data					-	vec3(	*(uvec2*)inputs[1].data, 0);		break;
				case  0x93: *(vec4*)	outputs[0].data	=			*(vec4*)	inputs[0].data					-	vec4(	*(uvec2*)inputs[1].data, 0, 0);		break;
				...
				case  0x96: *(ivec3*)	outputs[0].data	= ivec3(	*(ivec3*)	inputs[0].data)					-	ivec3(	*(uvec2*)inputs[1].data, 0);		break;
				case  0x97: *(ivec4*)	outputs[0].data	= ivec4(	*(ivec4*)	inputs[0].data)					-	ivec4(	*(uvec2*)inputs[1].data, 0, 0);		break;
				...
				case  0x9a: *(uvec3*)	outputs[0].data	=			*(uvec3*)	inputs[0].data					-	uvec3(	*(uvec2*)inputs[1].data, 0);		break;
				case  0x9b: *(uvec4*)	outputs[0].data	=			*(uvec4*)	inputs[0].data					-	uvec4(	*(uvec2*)inputs[1].data, 0, 0);		break;
				...
				case  0xa3: *(vec4*)	outputs[0].data	=			*(vec4*)	inputs[0].data					-	vec4(	*(uvec3*)inputs[1].data, 0);		break;
				...
				case  0xa7: *(ivec4*)	outputs[0].data	= ivec4(	*(ivec4*)	inputs[0].data)					-	ivec4(	*(uvec3*)inputs[1].data, 0);		break;
				...
				case  0xab: *(uvec4*)	outputs[0].data	=			*(uvec4*)	inputs[0].data					-	uvec4(	*(uvec3*)inputs[1].data, 0);		break;
