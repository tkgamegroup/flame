...
namespace flame
{
	...
	struct sHudPrivate : sHud
	{
		...
		void push_style_var(HudStyleVar idx, const vec4& value, uint num_styles) override;
		void pop_style_var(HudStyleVar idx, uint num_styles) override;
		void push_style_color(HudStyleColor idx, const cvec4& color, uint num_styles) override;
		void pop_style_color(HudStyleColor idx, uint num_styles) override;
		void push_style_image(HudStyleImage idx, const graphics::ImageDesc& image, uint num_styles) override;
		void pop_style_image(HudStyleImage idx, uint num_styles) override;
		void push_style_sound(HudStyleSound idx, audio::SourcePtr sound, uint num_styles) override;
		void pop_style_sound(HudStyleSound idx, uint num_styles) override;
