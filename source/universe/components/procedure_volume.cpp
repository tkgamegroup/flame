...
namespace flame
{
	...
	void cProcedureVolumePrivate::build_volume()
	{
		...
		auto img_dep = std::unique_ptr<graphics::Image>(graphics::Image::create(graphics::Format_Depth16, uvec3(512, 512, 1), graphics::ImageUsageAttachment | graphics::ImageUsageSampled));
		{
			graphics::InstanceCommandBuffer cb;
			...
			auto pl = graphics::GraphicsPipeline::get(L"flame\\shaders\\volume\\marching_cubes.pipeline", { "all_shader:OCCLUDER_PASS", "mesh:PUSH_TRANSFORM", "rp=" + str(rp_dep) });
