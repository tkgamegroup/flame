...
namespace flame
{
	namespace graphics
	{
		...
		struct CommandBufferPrivate : CommandBuffer
		{
			...
			CommandBufferPrivate__* operator->() { return (CommandBufferPrivate__*)this; }
			CommandBufferPrivate__* operator->() const { return (CommandBufferPrivate__*)this; }
		...
		struct CommandBufferPrivate__ : CommandBufferPrivate
		{
		...
		struct QueuePrivate : Queue
		{
			...
			QueuePrivate__* operator->() { return (QueuePrivate__*)this; }
			QueuePrivate__* operator->() const { return (QueuePrivate__*)this; }
		...
		struct QueuePrivate__ : QueuePrivate
		{
