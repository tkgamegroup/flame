...
namespace flame
{
	namespace graphics
	{
		...
		struct CommandBufferPrivate : CommandBuffer
		{
			...
			void image_barrier(ImagePtr img, const ImageSubresource& subresource, ImageLayout old_layout, ImageLayout new_layout, AccessFlags src_access = AccessNone, AccessFlags dst_access = AccessNone) override;
