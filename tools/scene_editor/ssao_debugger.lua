...
local radius_drag = e_radius_drag.find_driver("dDragEdit")
radius_drag.set_float(v_radius.get_())
local e_bias_drag = entity.find_child("bias_drag")
local bias_drag = e_bias_drag.find_driver("dDragEdit")
bias_drag.set_float(v_bias.get_())

e_radius_drag.add_driver_data_listener(function(h)
	s_renderer.set_ssao_props(radius_drag.get_float(), bias_drag.get_float())
end, radius_drag)

e_bias_drag.add_driver_data_listener(function(h)
	s_renderer.set_ssao_props(radius_drag.get_float(), bias_drag.get_float())
end, bias_drag)
