...
void cInspector::refresh()
{
	...
	{
		begin_item(L"name");
		auto c_text = ui::e_edit(100.f, s2w(app.selected->name()).c_str())->get_component(cText)
		...
		auto checkbox = ui::e_checkbox(L"", app.selected->visibility_)->get_component(cCheckbox)->
