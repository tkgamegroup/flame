...
struct MyApp : GraphicsApplication
{
	void on_render() override
	{
		...
		canvas->add_text(nullptr, 32, vec2(0.f), L"Hello World", cvec4(0, 0, 0, 255), 0.5f, 0.f);
...
{
	app.create("Graphics Test", uvec2(800, 600), WindowFrame | WindowResizable, false, true, { { "mesh_shader"_h, 0 } });
