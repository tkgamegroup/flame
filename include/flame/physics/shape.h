...
namespace flame
{
	namespace physics
	{
		...
		struct Shape
		{
			...
			FLAME_PHYSICS_EXPORTS static Shape* create(Material* m, ShapeType type, const ShapeDesc& desc, const Vec3f& coord = Vec3f(0.f), const Vec4f& quat = Vec4f(0.f, 0.f, 0.f, 1.f));
		};
	}
}
