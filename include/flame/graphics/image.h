...
namespace flame
{
	...
	namespace graphics
	{
		...
		struct Image
		{
			...
			FLAME_GRAPHICS_EXPORTS static Image* create(Device* d, const wchar_t* filename, ImageUsageFlags extra_usage = 0, bool create_defalut_view = true); // default usage: ShaderSampled, TransferDst
