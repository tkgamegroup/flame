...
namespace flame
{
	namespace graphics
	{
		...
		struct Canvas
		{
			...
			FLAME_GRAPHICS_EXPORTS void add_text_rightalign(FontAtlas* f, const Vec2f& pos, const Vec4c& col, const std::wstring& text, float scale/* for sdf */, const Vec4f& scissor);
